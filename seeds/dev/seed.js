...
const { SUPERADMIN_PASSWORD } = config;
...
async function seed(pg) {
    ...
    await pg("superstyles").insert([
...

        {
            ...
            title: "BLACK",
            text: "black",
            image: "http://localhost:3000/image/color1.png",
...

        {
            ...
            title: "BLUE",
            text: "blue",
            image: "http://localhost:3000/image/color2.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "COBALT",
            text: "cobalt",
            image: "http://localhost:3000/image/color3.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "ORANGE",
            text: "orange",
            image: "http://localhost:3000/image/color4.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "GOLD",
            text: "gold",
            image: "http://localhost:3000/image/color5.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "GREEN",
            text: "green",
            image: "http://localhost:3000/image/color6.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "PINK",
            text: "pink",
            image: "http://localhost:3000/image/color7.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "RED",
            text: "red",
            image: "http://localhost:3000/image/color8.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            title: "SILVER",
            text: "silver",
            image: "http://localhost:3000/image/color9.png",
            note: "Note: The lens images above are only representations of the actual color. Actual lens colors and appearance will vary based on lighting conditions, applied base tint color, and viewing angles. Mirror color illustrations shown above are for solid mirrors only. Flash mirrors are now shown in the illustrations above.",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },

        {
            ...
            image: "https://img1.wsimg.com/isteam/ip/6e793ce1-d799-4f0e-ac6e-0125429082dc/86726ad0-7ec4-4528-9948-d41f887d1e57.jpg/:/rs=w:400,cg:true,m",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        }
    ...
    await pg("superabout").insert([
        {
            ...
            image: "https://img1.wsimg.com/isteam/ip/6e793ce1-d799-4f0e-ac6e-0125429082dc/c8466294-eac6-423d-adcf-1e37beffe788.jpg/:/cr=t:2.83%25,l:0%25,w:100%25,h:94.34%25/rs=w:600,h:300,cg:true",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },
...

        {
            ...
            image: "https://img1.wsimg.com/isteam/ip/6e793ce1-d799-4f0e-ac6e-0125429082dc/5aeab6a2-bd73-4262-bf0f-6320ca78cca4.jpg/:/rs=w:600,h:300,cg:true,m/cr=w:600,h:300",
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },
    ])
    ...
    await pg("payment_methods").insert([
        {
            ...
            icon: "http://localhost:3000/upload/Paypal.png",
            created_at: new Date().toISOString(),
        },
        {
            title: 'Pay with Credit/Debit Card',
            icon: "http://localhost:3000/upload/logo-payment.png",
            created_at: new Date().toISOString(),
        },
        {
            title: 'Pay with Google Pay',
            icon: "http://localhost:3000/upload/54916a5d-8e56-4b85-813b-497f524dfb38.jpg",
            created_at: new Date().toISOString(),
        }
    ]);
    ...
    await pg("ship_methods").insert([
        {
            title: 'Ship in Fedex',
            icon: "http://localhost:3000/upload/eb8aa71b-3b57-4118-905f-521fdd124317.png",
            created_at: new Date().toISOString(),
        },
        {
            title: 'Ship in UPS',
            icon: "http://localhost:3000/upload/23c49151-a4aa-48c1-abbf-d79fa72c7142.png",
            created_at: new Date().toISOString(),
        },
        {
            title: 'Ship in USPS',
            icon: "http://localhost:3000/upload/6aeec8c2-9311-4be5-a088-5930819f9d46.png",
            created_at: new Date().toISOString(),
        }
    ]);
}
